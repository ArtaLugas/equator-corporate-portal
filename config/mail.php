...
return [
    ...
    */
    ...
    'mailers' => [
        ...
        /*
        | Brevo SMTP mailer. Host/port/credentials are overridden at runtime
        | from the CMS Settings (see App\Services\BrevoMailConfigurator) so the
        | configuration is never hardcoded. The env values below are fallbacks.
        */
        'brevo' => [
            'transport' => 'smtp',
