{{-- Renders a stat-card icon by key. Keeps SVG markup in Blade while the
     dashboard controller only passes a short icon name. Include with:
     @include('admin.partials.stat-icon', ['icon' => '...']) --}}
@php($icon = $icon ?? null)
