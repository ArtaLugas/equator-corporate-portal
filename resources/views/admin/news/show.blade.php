                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1.5 text-sm font-medium text-gray-900">
                            {{ $news->published_at?->format('d M Y, H:i') ?: '—' }}</p>
                    </div>
                    <div>
                        ...
                        @if ($news->tags->isNotEmpty())
                            <div class="mt-2 flex flex-wrap gap-2">
                                @foreach ($news->tags as $tag)
                                    <span
                                        class="rounded-lg bg-equator-dark/5 px-2.5 py-1 text-xs font-bold text-equator-dark">{{ $tag->name }}</span>
                                @endforeach
                            </div>
                        @else
