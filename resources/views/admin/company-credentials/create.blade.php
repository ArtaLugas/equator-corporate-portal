...
@section('content')
    ...
    <form action="{{ route('admin.company-credentials.store') }}" method="POST" enctype="multipart/form-data"
        class="space-y-6">
        ...
        <div class="flex flex-col-reverse justify-end gap-3 sm:flex-row">
            ...
            <button type="submit"
                class="inline-flex items-center justify-center rounded-xl bg-equator-dark px-5 py-3 text-sm font-semibold text-white transition hover:bg-equator-bright">Save
                Credential</button>
        </div>
