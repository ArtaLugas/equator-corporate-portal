...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm lg:p-8">
        ...
        <form action="{{ route('admin.about-histories.update', $aboutHistory) }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            ...
            <input type="hidden" name="return_url"
                value="{{ old('return_url', guarded_list_url(url()->previous(), route('admin.about-histories.index'))) }}">
